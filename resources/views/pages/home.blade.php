            ...
            <div class="row d-flex flex-row align-items-center h-100">
                ...
                <div class="col-12 col-md-6 d-none d-md-block">
                    <div class="banner_img">
                        <img src="{{asset('/img/Ska_rmavbild 2025-07-20 kl. 05.23.48.png')}}" alt="{{__('Make more money')}}"/>
                    </div>
...
{{--                    <img src="{{asset('/img/home-header.gif')}}" alt="{{__('Make more money')}}" class="img-fluid"/>--}}
    ...
    <div class="py-5 mt-4">
        <div class="container">
			<div class="text-center pb-5">
				<h2 class="font-weight-bolder ">{{__('Feature Scenes')}}</h2>
			</div>
            <div class="row">
                <div class="col-12 col-md-4 mb-5 mb-md-0">
                    <div class="d-flex justify-content-center">
                        <img src="{{asset('/img/Ska_rmavbild 2025-07-21 kl. 17.22.26.png')}}" class="img-fluid" alt="{{__('Paywall social network')}}">
                    </div>
                ...
                <div class="col-12 col-md-4 mb-5 mb-md-0">
                    <div class="d-flex justify-content-center">
                        <img src="{{asset('/img/Ska_rmavbild 2025-07-21 kl. 17.22.55.png')}}" class="img-fluid" alt="{{__('For fans and creators')}}">
                    </div>
                    <div class="d-flex justify-content-center mt-4">
                        <div class="col-12 col-md-10 text-center">
                ...
                <div class="col-12 col-md-4 mb-5 mb-md-0">
                    <div class="d-flex justify-content-center">
                        <img src="{{asset('/img/Ska_rmavbild 2025-07-21 kl. 17.23.41.png')}}" class="img-fluid" alt="{{__('Enjoy quality content')}}">
                    </div>
                    <div class="d-flex justify-content-center mt-4">
                        <div class="col-12 col-md-10 text-center">
    ...
    <div class="mt-5 home-bg-section">
        <div class="container py-4">
            <div class="row">
                <div class="col-12 col-md-6 second_baner">
                    <img src="{{asset('/img/Ska_rmavbild 2025-07-20 kl. 05.26.45.png')}}" class="home-mid" alt="{{__('Make more money')}}">
                </div>
